...
public class DelegatingLoginRiskEvaluator implements RiskEvaluator {

    private final List<LoginRiskEvaluator> loginRiskEvaluators;

    @Override
    public RiskScore evaluate(RiskEvent event) {
        return loginRiskEvaluators.stream()
